...
## Avantajları? <img src="/accept.png" alt="advantage" style="height:50px; width:50px;"/>
...
## Dezavantajları? <img src="/remove.png" alt="disadvantage" style="height:50px; width:50px;"/>
